...
function Animation({baseClass, conditionOnShow, duration, children}: AnimationProps) {

    const [animationProcess, setAnimationProcess] = useState<AnimationTypes>('entering');
